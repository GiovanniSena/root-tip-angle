...
color_skeleton = bwmorph(color_skeleton,'spur',15);
...
brightness_skeleton=bwmorph(brightness_skeleton,'spur',15); % Kind of a success. With these functions we get roots without little branches.
...
unified_skeleton=bwmorph(unified_skeleton,'spur',15); % Kind of a success. With these functions we get roots without little branches.
