...
uiwait(msgbox({'Press the tip of the root (In the image on the right).' 'Press BACKWARDS to delete point' 'Press ENTER when finished'},'User instructions','modal'));
...
function point_get(minnum,maxnum,srcx,srcy,relevant_axes)
  ...
  % legal number, defined as a number of points between minnum and maxnum.
  ...
  % Sending the data to the base workspace
