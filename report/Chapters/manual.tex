...
\title{\textbf{\textit{RootGUI} for Dummies -- a manual for the \textit{RootSkel} GUI}}
...
\section{Getting the angles -- main route}
...
%----------------------------------------------------------------------------------------
\subsection{Foreign objects removal}
...
%----------------------------------------------------------------------------------------
\section{Giving the problem a turning point}
