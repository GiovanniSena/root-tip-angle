...
Robustness and reproducability of \textit{RootSkel} nees to be further validated; suggestions for future work can be implemented. 

We hop \textit{RootSkel} will contribute to understand highly complex and poorly-understood phenomenons like eletrotropism in plants and possibly other tropisms, as well as plant growth in general.
