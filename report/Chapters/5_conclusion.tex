...
Angles computed by \textit{RootSkel} seem to correlate well with equivalent manual measures; based on angles of 3 Arabidopsis roots we showed that the computed by \textit{RootSkel} do not differ significantly (\(P >0.05\)) from the manually computed ones. % and, therefore, represent a good emulation thereof. 
