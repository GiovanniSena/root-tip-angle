...
Despite the error, we often consider such measures as a ‘ground truth’ or gold standard; that is, they represent a direct measure of the trait which we often consider to be error-free. 
